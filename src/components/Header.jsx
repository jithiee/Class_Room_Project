  ...
  return (
    <>
      ...
      <div className='flex flex-wrap'>
        ...
        <div className='w-full lg:w-[60%] h-auto'>
          <div className='w-full h-auto mx-auto md:h-[60rem]'>
            ...
            <div className='w-[80%] h-auto mx-auto mt-8 md:ml-32 space-y-4'>
              <p className='font-bold text-3xl md:text-7xl'>Building </p>
              ...
              <p className='font-bold text-3xl md:text-7xl'>For Future Success</p>
            </div>
        ...
        {/* second main =========== */}
        <div className='w-full lg:w-[40%] h-[50rem] bg-gray-100'>
          <div className=''>
            <HeaderLeft />
          </div>
        </div>
